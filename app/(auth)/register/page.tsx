  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-6 text-center">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white/90">Create an account</h2>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started with Raco Admin</p>
      </div>
          ...
          {({ errors, touched, isSubmitting }) => (
            <Form className="space-y-4">
              <div>
                ...
                <Field name="name" type="text" className={inputClass} placeholder="Your full name" />
              ...
              <div>
                ...
                <Field name="email" type="email" className={inputClass} placeholder="you@example.com" />
      ...
      <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <a href="/auth/login" className="font-medium text-brand-500 hover:text-brand-600">
          Sign in
        </a>
      </p>
    </div>
